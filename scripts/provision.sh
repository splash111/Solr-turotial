...
# Timezone
TIMEZONE="US/Eastern" # can be altered to your specific timezone, see http://manpages.ubuntu.com/manpages/jaunty/man3/DateTime::TimeZone::Catalog.3pm.html
...
#curl -O https://archive.apache.org/dist/lucene/solr/4.7.1/solr-4.7.1.zip
cd /
curl -O https://archive.apache.org/dist/lucene/solr/5.1.0/solr-5.1.0.zip
